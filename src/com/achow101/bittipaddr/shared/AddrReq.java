...
public class AddrReq implements IsSerializable {
    ...
    public String getHtml() {
        String out = "<table><tr></tr><tr><td>Your Unit ID is <b>" + this.id + "</b></td></tr>\n" +
                ...
                "<code>&lt;iframe src=\"http://bittipaddress.com/bittipaddr/addressfor/" + this.id + "\" style=\"border:none;\" scrolling=\"no\"&gt;&lt;/iframe&gt;</code></td></tr>\n" +
                "\n<tr><td>Use this for BBCode (Forums): </td><td><code>[url=http://bittipaddress.com/bittipaddr/addressfor/" + this.id + "?redirect]Tip Me![/url]</code></td></tr>\n" +
                "\n<tr><td>Use this for Reddit: </td><td><code>[Tip Me!](http://bittipaddress.com/bittipaddr/addressfor/" + this.id + "?redirect)</code></td></tr>\n";
        if(!xpub.equals("NONE"))
        {
